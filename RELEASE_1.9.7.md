...
- [ ] **#1565** — Number parsing breaks when user sets a non-C locale (e.g. `de_DE`)
...
- [ ] **#1595** — Linker errors with `string_view` API when jsoncpp built as C++11 but consumer uses C++17
